                        ...
                        <div className="col-sm-12">
                            ...
                            <div className="card">
                                <div className="card-body p-4">
                                    <div className="row">
                                        <label className="col-sm-4 col-form-label">Nama Modul</label>   
                                        <div className="col-sm-8">
                                            <label className="col-sm-10 col-form-label">: {modul.nama_modul}</label>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <label className="col-sm-4 col-form-label">Deskripsi atau Bahan ajar lain</label>
                                        <div className="col-sm-8">
                                    ...
                                    <div className="row">
                                        <label  className="col-sm-4 col-form-label">Program Studi</label>
                                        <div className="col-sm-8">
                                        <label className="col-sm-10 col-form-label">: {modul.nama_prodi}</label>
                                        </div>
                                    </div>
                                    <div className=" row">
                                        <label  className="col-sm-4 col-form-label">Dokumen Modul</label>
                                        <div className="col-sm-8">
